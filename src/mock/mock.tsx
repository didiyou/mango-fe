...
import { RandomDay } from '../shared/RandomDay'
...
export const mockItemSummary: Mock = (config) => {
  ...
  if (group_by === 'happen_at' && kind === 'expenses') {
    return [
      ...
      {
        groups: [
          { happen_at: `${randomDay.next().value}`, amount: 100 },
          { happen_at: `${randomDay.next().value}`, amount: 300 },
          { happen_at: `${randomDay.next().value}`, amount: 200 }
        ],
        summary: 600
      }
    ]
  ...
  return [
    200,
    {
      resource: {
        ...
        updated_at: '2023-07-03T15:35:56.301Z',
        kind: 'expenses'
      }
    }
  ]
